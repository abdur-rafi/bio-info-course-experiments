...
do
    ...
    do
        ...
        python ./scripts/arb_resolve_polytomies.py $current_gtFolderPath/$file/$gt_file_name
        python ./scripts/treeCleaner.py < $current_gtFolderPath/$file/$gt_file_name.resolved > $current_gtFolderPath/$file/$resolved
