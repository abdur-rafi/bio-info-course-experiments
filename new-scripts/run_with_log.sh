...
for model_cond in "${model_conds[@]}"; do
    ...
    # bash new-scripts/runDataset.sh ../astral2Cleaned "$model_cond" "$vanilla_output" \
    # "$vanilla_jar_path" 01 02 03 04 05 06 07 08 09 10 > "$log_output" 2> "$log_err"


    bash new-scripts/runDataset.sh ../astral2Cleaned "$model_cond" "$merged_input_transfer_optimized_output" \
    "$merged_input_transfer_optimized" 01 02 03 04 05 06 07 08 09 10 > "$log_output" 2> "$log_err"
done